...
<p align="center">
  ...
  <img src="https://img.shields.io/badge/Google%20Colab-Compatible-F9AB00?style=flat-square&logo=googlecolab&logoColor=white"/>
...
1. **Collecter** les données de comptage routier depuis l'Open Data Paris
2. **Analyser** les patterns de trafic (temporels, géographiques, saisonniers)
3. **Modéliser** les relations entre axes routiers pour prédire les reports de charge
4. **Simuler** la fermeture d'axes et estimer l'impact sur le réseau adjacent
5. **Visualiser** les résultats via un dashboard interactif Streamlit
...
|--------|---------|--------|------|
| Open Data Paris | Comptages routiers — Données de trafic | CSV | [opendata.paris.fr](https://opendata.paris.fr/explore/dataset/comptages-routiers-permanents/information/) |
...
[![Open In Colab](https://colab.research.google.com/assets/colab-badge.svg)](https://colab.research.google.com/github/yannis-cloud/PariData/blob/main/notebooks/PariData_Colab.ipynb)
...
**Yannis Albert**
Ingénieur Systèmes Numériques — Candidat Master IA & Data Science

- 📧 yannis.albert78@gmail.com
- 💼 [LinkedIn](https://linkedin.com/in/yannis-albert)
- 🐙 [GitHub](https://github.com/yannis-cloud)
- 🌐 [Portfolio](https://yannis-cloud.github.io/yannis-albert-portfolio/)
